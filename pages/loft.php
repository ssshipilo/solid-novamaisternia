...
$arr = getFolder('./category/Меблі лофт');
$iter = count($arr);
...
<main class="main" role="main">
    <section class="page_start">
        <div class="content">
            <div class="layer" style="background: url('/build/img/title_page/loft.jpg')  center / cover no-repeat;  background-attachment: fixed;">
        </div>
        <div class="text"><p>Меблі лофт</p></div>
    </section>
