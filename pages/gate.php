...
$arr = getFolder('./category/Ворота-Забори');
$iter = count($arr);
...
<main class="main" role="main">
    <section class="page_start">
        <div class="content">
            <div class="layer" style="background:  url('/build/img/title_page/gate.jpg') center / cover no-repeat;  background-attachment: fixed;">
        </div>
        <div class="text"><p>Ворота/Забори</p></div>
    </section>
